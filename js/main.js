...
import { initializeUsers, cleanupUsers } from './users.js?v=2026.07.15.18';
import { initializeProductivity, cleanupProductivity } from './productivity.js?v=2026.07.15.18';
import { initializeSchedule, cleanupSchedule } from './schedule.js?v=2026.07.15.18';
import { initializeReports, cleanupReports } from './reports.js?v=2026.07.15.18';
import { initializeInfoVersion } from './info-version.js';
import { initializeInfoInteractive } from './info-interactive.js';
import { initializeCharts, initializeProductivityChart } from './charts.js?v=2026.07.15.18';
import { updateAverageProductivityCard } from './dashboard.js?v=2026.07.15.18';
import { setTheme, updateLanguageUI, showSection, openEditModal, selectEditType, saveModalChanges, closeEditModal, toggleSidebar } from './ui.js?v=2026.07.15.18';
...
import {
    ...
    showLoginScreen
} from './app-shell-wiring.js?v=2026.07.15.18';
import { initLogoAnimation } from './logo-animation.js?v=2026.07.15.18';
import { initializeChat, cleanupChat } from './chat.js?v=2026.07.15.18';
import { loginWithGoogle, logout, onAuthChange } from './auth.js?v=2026.07.15.18';
import { initializeLogs, setLogUser, logActivity } from './logs.js?v=2026.07.15.18';
