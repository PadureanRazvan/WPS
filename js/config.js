...
export const translations = {
    ro: {
        ...
        'info-dashboard-agents': 'Cardul Total Agenți afișează numărul total de agenți încărcați din baza de date',
        ...
        'info-users-team': 'Echipa primară — echipa principală a agentului. Sunt suportate echipe customer (ex: RO zooplus) și roluri operaționale precum 2L, QA sau TL',
        ...
        'info-planner-nav': 'Navigare luni — folosește săgețile ◀ ▶ pentru a trece rapid la luna anterioară sau următoare',
        'info-planner-monthly': 'Date lunare independente — fiecare lună are propriile date; editările într-o lună nu afectează altele. Programul de bază respectă data exactă de angajare',
        'info-planner-format': 'Format ore — introdu orele cu codul echipei: 8RO = 8 ore pe RO, 4RO+4IT = 4 ore RO + 4 ore IT',
        'info-planner-codes': 'Coduri speciale — Co = Concediu, CM = Concediu Medical, SL = Sărbătoare Legală, LB = Liber, MA = Maternitate, DO = Donare Sânge, DC = Deces, DZ = Dezactivat',
        ...
        'info-prod-desc': 'Analiza productivității bazată pe datele încărcate (tickete + apeluri) și orele eligibile din planner:',
        ...
        'info-team-2l': 'Second Level',
        'info-team-qa': 'Quality Assurance',
        'info-team-tl': 'Team Lead',
        ...
        'roadmap-bug-7': 'Dropdown-ul Contract Type deschide modalul „Change to Full-time” la al doilea click, chiar dacă selecția rămâne Full-time',
...
'confirm-delete-user-impact': 'Ștergerea va opri potrivirea viitoare în Productivitate pentru această persoană. Pentru plecări, folosește Inactiv în loc de ștergere.',
    ...
    en: {
        ...
        'info-dashboard-agents': 'The Total Agents card shows the total number of agents currently loaded from the database',
        ...
        'info-users-team': 'Primary team — the agent\'s main team. Supported values include customer teams (for example RO zooplus) and operational roles such as 2L, QA, or TL',
        ...
        'info-planner-nav': 'Month navigation — use the ◀ ▶ arrows to move quickly to the previous or next month',
        'info-planner-monthly': 'Independent monthly data — each month has its own data; edits in one month do not affect others. Base schedules respect the exact hire date',
        'info-planner-format': 'Hours format — enter hours with team code: 8RO = 8 hours on RO, 4RO+4IT = 4 hours RO + 4 hours IT',
        'info-planner-codes': 'Special codes — Co = Holiday, CM = Sick Leave, SL = Legal Holiday, LB = Day Off, MA = Maternity, DO = Blood Donation, DC = Bereavement, DZ = Deactivated',
        ...
        'info-prod-desc': 'Productivity analysis based on uploaded data (tickets + calls) and eligible planner hours:',
        ...
        'roadmap-bug-7': 'Contract Type dropdown opens the "Change to Full-time" modal on the second click even when the selection stays Full-time',
...
'confirm-delete-user-impact': 'Deleting will stop future Productivity matching for this person. For leavers, use Inactive instead of delete.',
    ...
    it: {
        ...
        'info-dashboard-agents': 'La card Totale Agenti mostra il numero totale di agenti attualmente caricati dal database',
        ...
        'info-users-team': 'Team primario — il team principale dell\'agente. I valori supportati includono team customer (es. RO zooplus) e ruoli operativi come 2L, QA o TL',
        ...
        'info-planner-nav': 'Navigazione mesi — usa le frecce ◀ ▶ per passare rapidamente al mese precedente o successivo',
        'info-planner-monthly': 'Dati mensili indipendenti — ogni mese ha i propri dati; le modifiche in un mese non influenzano gli altri. I programmi base rispettano la data esatta di assunzione',
        'info-planner-format': 'Formato ore — inserisci le ore con il codice team: 8RO = 8 ore su RO, 4RO+4IT = 4 ore RO + 4 ore IT',
        'info-planner-codes': 'Codici speciali — Co = Ferie, CM = Malattia, SL = Festività, LB = Giorno Libero, MA = Maternità, DO = Donazione Sangue, DC = Lutto, DZ = Disattivato',
        ...
        'info-prod-desc': 'Analisi della produttività basata sui dati caricati (ticket + chiamate) e le ore eleggibili del planner:',
        ...
        'roadmap-bug-7': 'Il menu a discesa Contract Type apre il modale "Change to Full-time" al secondo clic anche se la selezione rimane Full-time',
