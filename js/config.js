...
export const translations = {
    ro: {
        ...
        'info-dashboard-trend': 'Trend Productivitate — graficul arată productivitatea per echipă (tickete+apeluri / oră) pe lună, cu săgeți ◀ ▶ pentru navigare între luni',
        ...
        'info-planner-codes': 'Coduri speciale — Co = Concediu, CM = Concediu Medical, SL = Sărbătoare Legală, LB = Liber, MA = Maternitate, DO = Donare Sânge, DC = Deces',
    ...
    en: {
        ...
        'info-dashboard-trend': 'Productivity Trend — the chart shows productivity per team (tickets+calls / hour) per month, with ◀ ▶ arrows to browse months',
        ...
        'info-planner-codes': 'Special codes — Co = Holiday, CM = Sick Leave, SL = Legal Holiday, LB = Day Off, MA = Maternity, DO = Blood Donation, DC = Bereavement',
    ...
    it: {
        ...
        'info-dashboard-trend': 'Trend Produttività — il grafico mostra la produttività per team (ticket+chiamate / ora) per mese, con frecce ◀ ▶ per navigare tra i mesi',
        ...
        'info-planner-codes': 'Codici speciali — Co = Ferie, CM = Malattia, SL = Festività, LB = Giorno Libero, MA = Maternità, DO = Donazione Sangue, DC = Lutto',
