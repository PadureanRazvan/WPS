...
export const translations = {
    ro: {
        'chat-review-changes': 'Verifică modificările propuse. Nimic nu a fost salvat încă.',
        'chat-apply-changes': 'Aplică modificările',
        'chat-cancel-changes': 'Anulează',
        'chat-changes-applied': 'Modificările au fost salvate.',
        'chat-changes-cancelled': 'Modificările propuse au fost anulate.',
        'chat-invalid-actions': 'Propunerea conține date invalide sau ambigue. Cere o propunere nouă.',
        'chat-propose-delete': 'Șterge agentul',
        'chat-propose-add': 'Creează agentul',
        'chat-delete-warning': 'Ștergerea este permanentă și elimină agentul împreună cu întregul său istoric de planificare.',
        'chat-cleared': 'gol',
        'chat-over-contract': 'Depășește orele contractuale',
        'chat-done': 'Gata.',
        'write-conflict': 'Datele au fost modificate între timp. Reîmprospătează și verifică modificările înainte de a salva din nou.',
        'write-failed': 'Modificările nu au fost salvate. Verifică conexiunea și încearcă din nou.',
        // Dashboard
        ...
        'prod-select-agent': 'Selectează un agent pentru a vedea detaliile.',
        'prod-search-to-select-agent': 'Începe să scrii numele agentului.',
        ...
        'prod-agent-picker-label': 'Agent pentru analiză',
        'prod-agent-selected': '1 agent selectat',
...
'confirm-delete-user-impact': 'Ștergerea va opri potrivirea viitoare în Productivitate pentru această persoană. Pentru plecări, folosește Inactiv în loc de ștergere.',
    ...
    en: {
        'chat-review-changes': 'Review the proposed changes. Nothing has been saved yet.',
        'chat-apply-changes': 'Apply changes',
        'chat-cancel-changes': 'Cancel',
        'chat-changes-applied': 'Changes saved.',
        'chat-changes-cancelled': 'Proposed changes cancelled.',
        'chat-invalid-actions': 'The proposal contains invalid or ambiguous data. Ask for a new proposal.',
        'chat-propose-delete': 'Delete agent',
        'chat-propose-add': 'Create agent',
        'chat-delete-warning': 'Deletion is permanent and removes the agent and their entire planning history.',
        'chat-cleared': 'empty',
        'chat-over-contract': 'Exceeds contract hours',
        'chat-done': 'Done.',
        'write-conflict': 'Data changed while you were editing. Refresh and review the changes before saving again.',
        'write-failed': 'Changes were not saved. Check your connection and try again.',
        // Dashboard
        'dashboard-title': 'Dashboard',
        ...
        'prod-select-agent': 'Select an agent to view detailed productivity.',
        ...
        'prod-agent-picker-label': 'Agent to analyze',
...
'confirm-delete-user-impact': 'Deleting will stop future Productivity matching for this person. For leavers, use Inactive instead of delete.',
    ...
    it: {
        'chat-review-changes': 'Verifica le modifiche proposte. Non è stato ancora salvato nulla.',
        'chat-apply-changes': 'Applica modifiche',
        'chat-cancel-changes': 'Annulla',
        'chat-changes-applied': 'Modifiche salvate.',
        'chat-changes-cancelled': 'Modifiche proposte annullate.',
        'chat-invalid-actions': 'La proposta contiene dati non validi o ambigui. Richiedi una nuova proposta.',
        'chat-propose-delete': 'Elimina agente',
        'chat-propose-add': 'Crea agente',
        'chat-delete-warning': 'L’eliminazione è permanente e rimuove l’agente e tutta la sua cronologia di pianificazione.',
        'chat-cleared': 'vuoto',
        'chat-over-contract': 'Supera le ore contrattuali',
        'chat-done': 'Fatto.',
        'write-conflict': 'I dati sono cambiati durante la modifica. Aggiorna e verifica le modifiche prima di salvare di nuovo.',
        'write-failed': 'Le modifiche non sono state salvate. Controlla la connessione e riprova.',
        // Dashboard
        'dashboard-title': 'Dashboard',
        ...
        'prod-select-agent': 'Seleziona un agente per vedere la produttività dettagliata.',
        'prod-search-to-select-agent': 'Inizia a digitare il nome dell\'agente.',
        ...
        'prod-agent-picker-label': 'Agente da analizzare',
        'prod-agent-selected': '1 agente selezionato',
