...
import { translations } from './config.js?v=2026.07.16';
import { buildReportReadModel } from './report-read-model.js?v=2026.07.16';
import { renderReportsView } from './reports-view.js?v=2026.07.16';
