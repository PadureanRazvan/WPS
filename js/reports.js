...
import { translations } from './config.js?v=2026.09.06';
import { buildReportReadModel } from './report-read-model.js?v=2026.09.06';
import { renderReportsView } from './reports-view.js?v=2026.09.06';
