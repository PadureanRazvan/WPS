...
test('Global Motion cache-busts the productivity picker and shared shell', async () => {
  ...
  assert.match(productivitySource, /config\.js\?v=2026\.09\.06/);
  assert.match(productivitySource, /productivity-controls\.js\?v=2026\.09\.06/);
  assert.match(productivitySource, /productivity-agent-actions\.js\?v=2026\.09\.06/);
  assert.match(productivitySource, /productivity-agent-selection-view\.js\?v=2026\.09\.06/);
  assert.match(productivitySource, /productivity-agent-combobox\.js\?v=2026\.09\.06/);
  assert.match(html, /components\.css\?v=2026\.09\.06/);
  assert.match(html, /main\.js\?v=2026\.09\.06/);
