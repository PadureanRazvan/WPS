...
test('current release cache-busts the upload calendar modules', () => {
  assert.match(productivitySource, /from '\.\/productivity-upload-calendar-view\.js\?v=2026\.07\.20\.1'/);
  assert.match(productivitySource, /from '\.\/productivity-upload-calendar-actions\.js\?v=2026\.07\.20\.1'/);
});
