...
test('current release cache-busts the upload calendar modules', () => {
  assert.match(productivitySource, /from '\.\/productivity-upload-calendar-view\.js\?v=2026\.09\.06'/);
  assert.match(productivitySource, /from '\.\/productivity-upload-calendar-actions\.js\?v=2026\.09\.06'/);
});
