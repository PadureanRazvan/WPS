...
test('users directory exposes searchable and filterable controls with a live result count', () => {
  ...
  assert.match(mainSource, /from '\.\/users\.js\?v=2026\.07\.16'/);
  assert.match(uiSource, /from '\.\/users\.js\?v=2026\.07\.16'/);
  assert.match(usersSource, /from '\.\/ui\.js\?v=2026\.07\.16'/);
  assert.match(usersSource, /from '\.\/users-directory\.js\?v=2026\.07\.16'/);
});
