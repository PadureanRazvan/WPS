...
test('report atlas cache-busts the complete Reports renderer chain', () => {
  assert.match(mainSource, /from '\.\/reports\.js\?v=2026\.07\.15\.17'/);
  assert.match(reportsSource, /from '\.\/report-read-model\.js\?v=2026\.07\.15\.17'/);
  assert.match(reportsSource, /from '\.\/reports-view\.js\?v=2026\.07\.15\.17'/);
});
